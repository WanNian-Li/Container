...
sys.path.append(os.path.join(current_path,'Model'))
from Module import Genal_CNN, Genal_LSTM
...
dataset_save_directory = os.path.join('dataset', f'{stack}-{tier}-{total_number}')

save_directory = os.path.join('result', f'{stack}-{tier}-{"CNN"}')
